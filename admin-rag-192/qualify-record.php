...
<!-- Users data list -->
<form name="bulk_action_form" action="" method="post" onSubmit="return qualify_confirm();"/>
	...
	<input type="submit" class="btn btn-primary" name="bulk_qualify_submit" value="QUALIFY STUDENT"/>
</form>
...
function qualify_confirm(){
    if($('.checkbox:checked').length > 0){
        var result = confirm("Are you sure to qualify selected users?");
        if(result){
            return true;
        }else{
            return false;
        ...
        alert('Select at least 1 record to qualify.');
        return false;
    }
}
</script>
