...
#id::before {
  ...
  width: 100%;
  height: 100%;
  background: url('../asset/Cei/Press Card Front.jpg');   /*if you want to change the background image replace logo.png*/
...
.data{
 ...
 .id-1{
  	...
  	background: url('../asset/Cei/Press Card Back.jpg');   /*if you want to change the background image replace logo.png*/
	background-repeat:repeat-x;
	background-size: 305px 482px;
	border-radius:2%;
	margin-top: 481.7px;
		            ...
		            <div id="id">
		                    ...
		                    <!-- to show image on the card  -->
		             	     ...
		             	     <div class="container front" align="center">
		             	 	 	<img src="../operation/image/img/<?php echo $row['image']; ?>" height="162" width="123" style="align-content: center;align-items: center; margin-left: -12px;">
		                    ...
		                    <div class="container back2">
                                           <p class="my-1 fs-16 text text-dark d-flex"><span class="text2"><b>Company Name</b></span><b>:</b><span class="text4"><b><?php echo $row['company_id']; ?></span></b>
                                           <p class="my-1 fs-16 text text-dark d-flex"><span class="text2"><b>Employee Id</b></span><b>:</b><span class="text4"><b><?php echo $row['emp_id']; ?></b></span></p>
		            ...
		            <div class="id-1">
		            	...
		            	<!-- to show qr image on the card  -->
		                    ...
		                    <div class="container back">
                                       ...
                                       <p class="my-1 fs-16 text text-dark d-flex"><span class="text2"><b>Date Of Birth</b></span><b>:</b><span class="text3"><b><?php echo $row['date_of_birth']; ?></b></span></p>
