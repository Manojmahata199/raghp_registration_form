...
#id::before {
  ...
  width: 100%;
  height: 100%;
  background: url('<?php echo base_link;?>asset/SPF/Press Card Front.jpg');   /*if you want to change the background image replace logo.png*/
...
.data{
 ...
 .id-1{
  	...
  	background: url('<?php echo base_link;?>asset/SPF/Press Card Back.jpg');   /*if you want to change the background image replace logo.png*/
	background-repeat:repeat-x;
	background-size: 305px 482px;
	border-radius:2%;
	margin-top: 481.7px;
