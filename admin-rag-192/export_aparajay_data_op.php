...
// 'Ankur','Ankur Activity In Words','Ankur Activity Filename','All Activity Filename','Yuva','Marksheet Filename','Board Total Marks','Board Hindi Mark','Hindi Mark Percent','Qualified','Verified','Hindi Grade','Hindi Teacher Name','Hindi Teacher Mobile','Essay File','Essay Video'
	   ...
	   <tr>
	            ...
	            <td>Disorder</td>
	            <td>Physical Disorder Name</td>
	            <td>Mental Disorder Name</td>
	            <td>Disorder Description</td>
	            <td>Disorder Filename</td>
	            <td>First Name</td>
	            <td>Last Name</td>
	            <td>Hindi First Name</td>
	            <td>Hindi Last Name</td>
	            ...
	            <td>Family Income</td>
                   ...
                   <td>Participated In RAGP</td>
                   <td>Ragp Roll No</td>
                   <td>RAGP Hindi Marks</td>
...
// `id`, `form_date_time`, `reg_id`, `ip_address`, `reg_location`, `boardexam`, `category`, `disorder`, `phy_disorder_name`, `mental_disorder_name`, `disorder_detail`, `disorder_file`, `fname`, `lname`, `hname`, `hlname`, `student_photo_file`, `hname_correct`, `hname_file`, `student_gender`, `student_dob`, `student_email`, `student_mobile`, `board_roll_no`, `admit_card_file`, `school_name`, `school_address`, `other_school_name`, `other_school_address`, `school_medium`, `class`, `last_year_marks1`, `last_year_marks2`, `last_year_marks3`, `current_year_marks1`, `current_year_marks2`, `current_year_preboards`, `marksheet_one`, `marksheet_eleven`, `parent_name`, `parent_mobile`, `emergency_landline`, `parent_email`, `home_address`, `city`, `state`, `pincode`, `family_income`, `facebook_handle`, `twitter_handle`, `ragaward_source`, `ragaward_source_other`, `sanmarg_reader`, `hawker_name`, `hawker_telephone`, `rag_pariksha_participated`, `rag_pariksha_rollno`, `rag_pariksha_marks`, `rag_participated_chk`, `ankur`, `ankur_activity_textwork`, `ankur_activity_file`, `all_activity_file`, `yuva`, `marksheet_file`, `board_total_mark`, `board_hindi_mark`, `Board_hindi_mark_percent`, `qualified`, `verified`, `hindi_grade`, `hnd_tech_name`, `hnd_tech_mob`, `essay_file`, `essay_video`
	            	...
	            	$html.='<tr>
	            	            ...
	            	            <td>'.$result['family_income'].'</td>
                                 ...
                                 <td>'.$result['rag_pariksha_participated'].'</td>
                                 <td>'.$result['rag_pariksha_rollno'].'</td>
                                 <td>'.$result['rag_pariksha_marks'].'</td>
                                 ...
                                 <td>'.$result['hindi_grade'].'</td>
                                 <td>'.$result['hnd_tech_name'].'</td>
                                 <td>'.$result['hnd_tech_mob'].'</td>
                                 <td>'.$stu_essay_file_link.'</td>
                                 <td>'.$stu_essay_video_link.'</td>
				...
				header("Content-Disposition: attachment; filename=RAGHP_REGISTRATION_DATA-SA-STUDENT(".$today_date.").xls"); 
				header("Expires: 0");
