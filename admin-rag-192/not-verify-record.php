...
<div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-lg-12">
                     <h2>Student Data Not Verified</h2>
                    </div>
                </div>
...
<!-- Users data list -->
<form name="bulk_action_form" action="" method="post" onSubmit="return notverify_confirm();"/>
	...
	<input type="submit" class="btn btn-success" name="bulk_notverify_submit" value="NOT VERIFIED STUDENT"/>
</form>
...
function notverify_confirm(){
    if($('.checkbox:checked').length > 0){
        var result = confirm("Are you sure selected student is not verified?");
        if(result){
            return true;
        }else{
            return false;
