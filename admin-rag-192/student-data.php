            ...
            <div id="page-inner">
                <div class="row">
					...
					?>
						...
						<tbody>
						<tr>
							<td><b>Registration Roll No :</b>RAGHP-<?php echo  $row['boardexam']."-".substr("0000000{$row['reg_id']}", -7); ?></td>
                   ...
                   echo 'No';
						...
						<tr>
					   <td>
					   	  <b>Disorder File :</b><?php echo $row['disorder_file']." ";?>
               ...
               <?php if($row['disorder_file']!=""){ ?>
                   ...
                   <a href="#">No File Uploaded</a>
		             ...
		             <?php if($row['hname_file']!=""){ ?>
						...
						<tr>
							    ...
							    <td colspan="2"><b>School Address :</b><?php echo $row['school_address']?></td>
						</tr>

						<tr>
										
										<td><b>Other School Name :</b><?php echo $row['other_school_name']?></td>
										<td colspan="2"><b>Other School Address :</b><?php echo $row['other_school_address']?></td>
						</tr>
                ...
                <td><b>Hindi Teacher Phone No :</b><?php echo $row['hnd_tech_mob']?></td>
						...
						<tr>
							  <td>
						       ...
						       <?php if($row['marksheet_one']!=""){ ?>
						                  ...
						                  <a href="../uploads/<?php echo $row['id']?>/nine_marksheet/<?php echo $row['marksheet_one']; ?>" target="_blank">Click to Open</a>
												    <?php }else if($row['marksheet_eleven']!=""){ ?>


						                  <b>Class 11th Marksheet:</b><?php echo $row['marksheet_eleven']." ";?>
						                  <a href="../uploads/<?php echo $row['id']?>/marksheet_eleven/<?php echo $row['marksheet_eleven']; ?>" target="_blank">Click to Open</a>
						...
						<tr>
								<td><b>Name of a family member <br>who has taught you hindi :</b><?php echo $row['members_name']?></td>
								<td><b>Relationship with <br>the Family Member :</b><?php echo $row['relationship']?></td>
								<td><b>Regular Reader of Sanmarg :</b><?php echo $row['sanmarg_reader']?></td>
