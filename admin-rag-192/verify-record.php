...
<!-- Users data list -->
<form name="bulk_action_form" action="" method="post" onSubmit="return verify_confirm();"/>
	...
	<input type="submit" class="btn btn-success" name="bulk_verify_submit" value="VERIFY STUDENT"/>
</form>
...
function verify_confirm(){
    if($('.checkbox:checked').length > 0){
        var result = confirm("Are you sure to verify selected users?");
        if(result){
            return true;
        }else{
            return false;
        ...
        alert('Select at least 1 record to verify.');
        return false;
    }
}
</script>
